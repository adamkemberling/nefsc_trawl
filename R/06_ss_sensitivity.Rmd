...
output: 
  html_document:
    includes:
        before_body: support/gmri_logo_header.html
        after_body: support/akemberling_gmri_footer.html
    css: support/gmri_rmarkdown.css
    toc: TRUE
    toc_float:
        collapsed: FALSE
    code_folding: hide
...
size_cutoffs <- c(seq(0, 25, by = .5), seq(30, 200, by = 5))
