...
summs %>% 
  ...
  labs(x = "", y = "Mean Individual Biomass (g)", title = "Clearly Wrong - ignore") +
...
top_5 <- trawldat %>% 
  ...
  summarise(n_fish = sum(numlen_adj),
            lw_biomass = sum(sum_weight_g) / 1000) %>% 
  ungroup() %>% 
  split(.$est_year) %>% 
...
t1 <- ((t5_plots$`2008` | t5_plots$`2009`) / (t5_plots$`2010` | t5_plots$`2011`))
t2 <- ((t5_plots$`2012` | t5_plots$`2013`) / (t5_plots$`2014` | t5_plots$`2015`))
t3 <- ((t5_plots$`2016` | t5_plots$`2017`) / (t5_plots$`2018` | t5_plots$`2019`))
```
