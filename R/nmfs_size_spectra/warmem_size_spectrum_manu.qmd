...
# Check each for different breakpoint structures
...
# Plot GOM, the only one with breakpoints
...
Breakpoint analyses suggest there were as many as 3 distinct regimes in the Gulf of Maine slope changes. For all other regions there was not strong support for breakpoints.
...
# Incorporate the patterns from the breakpoint analysis
