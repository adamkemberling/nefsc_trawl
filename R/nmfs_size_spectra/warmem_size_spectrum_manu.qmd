...
# fit model with all parameters
all_parms <- glm(`ISD Exponent` ~ SST * GSI + `Commercial Landings` + decade, data = gb_df)
...
#grab best model
# subset(results, delta == 0)
bmod <- glm(`ISD Exponent` ~ GSI, data = gb_df)
...
# fit model with all parameters
all_parms <- glm(`ISD Exponent` ~ SST * GSI + `Commercial Landings` + decade, data = sne_df)
...
#grab best model
# subset(results, delta == 0)
bmod <- glm(`ISD Exponent` ~ `Commercial Landings`, data = sne_df)
...
# fit model with all parameters
all_parms <- glm(`ISD Exponent` ~ SST * GSI + `Commercial Landings` + decade, data = mab_df)
...
#grab best model
# subset(results, delta == 0)
bmod <- glm(`ISD Exponent` ~ regime, data = mab_df)
