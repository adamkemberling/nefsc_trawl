...
![](images/garfo_regions.png){fig-align="center",width = "420"}
...
landings %>% 
  ...
  fmt_number(columns = c(avg_landings_lb, total_landings_lb, total_value),
             ...
             suffixing = T) %>% 
  cols_label(
    sppname = "Harvest Region & Time Period",
    avg_landings_lb = "Avg. Annual Landings (lb.)",
    total_landings_lb = "Total Landings (lb.)",
    total_value = "Total Value ($)") %>%
  gt::tab_header(title = "Top Landings by Weight")
