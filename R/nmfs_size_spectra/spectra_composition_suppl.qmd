...
#'
#' @examples
compare_spectra_components <- function(functional_group_aggregates, annual_aggregates, filter_years = 2012, fill_group){
...
year_group_aggregates %>% 
  ...
  mutate(
    observed_abundance = ifelse(observed_abundance == 0, NA, observed_abundance),
    log10_bins = as.numeric(as.character(log10_bins))) %>% 
  ggplot(aes(Year, log10_bins, fill = observed_abundance)) +
  geom_point() +
