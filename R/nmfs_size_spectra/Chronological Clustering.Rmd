 ...
 **Significant Trends in Biomass**
```{r}
fgroup_trends %>% filter(significance == "significant")
```
 
 **Differences in Relative Biomass**
...
**Difference in Average Annual Biomass**
 ...
 **Differences in Average Individual Mass**
 ...
 **Differences in Average Individual Length**
