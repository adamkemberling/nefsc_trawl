...
# Plotting different ways to treat biomass
ggplot() +
...
Haddock is one of the most commonly caught species, particularly true in the recent years. It also **had** a particularly high prevalence for large deviance from the two biomass sources.

Here is how it looks following come corrections to the survdat build.
