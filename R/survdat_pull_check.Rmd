...
The conversion factor is helpful for identifying consistency in behavior across the different pulls, but doesn't really explain the how/why of the differences among them.

To get at the differences that contribute to them we use four commonly caught species to compare different components of the datasets.
