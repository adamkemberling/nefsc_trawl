...
For the following report we looked at 6 candidate survdat datasets.
...
pull_pivot_plot <- function(target_comname = "haddock", comparison = c("Jan 2021", "2016-2019")){
  ...
  annual_totals <- trawldat_combined %>% 
    filter(survdat_source %in% c("2019", "2021", "Feb 2021"), 
  ...
  yr_ratios <- annual_totals %>% 
    ...
    mutate(
      b_ratio_febto2021 = `biomass_Feb 2021` / biomass_2021,
      b_ratio_febto2019 = `biomass_Feb 2021` / biomass_2019,
      a_ratio_febto2021 = `abundance_Feb 2021` / abundance_2021,
      a_ratio_febto2019 = `abundance_Feb 2021` / abundance_2019)
