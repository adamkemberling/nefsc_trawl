...
# Same file but with additional columns from Sean
...
ab_abund <- haddock_data %>% 
  ggplot(aes(est_year)) +
  geom_line(aes(y = abund_19, color = "Survdat Nye - August 2020")) +
...
ab_abund <- lob_data %>% 
  ...
  scale_y_continuous(labels = scales::comma_format()) +
  scale_x_continuous(breaks = scales::pretty_breaks()) +
  labs(x = "", y = "Abundance", subtitle = "American Lobster Absolue Abundance", color = "") +
  theme(legend.position = "bottom")
...
ab_abund <- haddock_data %>% 
  ggplot(aes(est_year)) +
  geom_line(aes(y = abund_20, color = "Survdat Nye Allseason 2019")) +
  geom_line(aes(y = abund_21, color = "Newest Survdat")) +
  scale_color_gmri() +
  scale_y_continuous(labels = scales::comma_format()) +
  scale_x_continuous(breaks = scales::pretty_breaks()) +
