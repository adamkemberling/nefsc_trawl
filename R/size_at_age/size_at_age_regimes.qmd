...
```{r}
heatwave_heatmap_plot(hw_dat = shelf_hw, temp_units = "C", start_yr = 1982, end_yr = 2021) + 
  theme_bw() +
...
```{r}
heatwave_heatmap_plot(hw_dat = gom_hw, temp_units = "C", start_yr = 1982, end_yr = 2021) + 
  theme_bw() +
  theme(legend.title = element_text(angle = 90)) +
