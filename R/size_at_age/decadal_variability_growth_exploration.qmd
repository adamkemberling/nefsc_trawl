...
# 
# # palette for bars
# winloss_pal <- c(gmri_cols("teal"), gmri_cols("yellow"), "gray70")
# 
# 
...
#   tab_footnote(
#     footnote = md('Colored bars indicate the change in an ageclass characteristic moving from the periods of 1970-2009 to 2010-2019. Bars in <a style="color:#EACA00">yellow color indicate significant declines in length or weight.</a> Bars colored in <a style="color:#00736D">teal color indicate significant increases in length or weight.</a> And bars in <a style="color:#B3B3B3">gray</a> indicate no difference in ageclass characteristics.</a>' ),
...
### Change in Growth Table



```{r}
#| label: exporting-pdf-table
#| eval: false
