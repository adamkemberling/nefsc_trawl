####  Hierarchical Growth Model - JAGS
#### 11/19/2021
#### Source: Grant Adams
...
writeLines(jags.mod, here::here("R/size_at_age/jags_model.txt"))
...
runJagsOut <- run.jags(model = here::here("R/size_at_age/jags_model.txt") ,
  monitor = params ,
  data = dat ,
  n.chains = nc ,
  adapt = na ,
...
library(bayesplot)
bayesplot::mcmc_areas_ridges(runJagsOut$mcmc)
