...
saa_table <- function(
  ...
  if(as_html){ saa_table_gt %>% as_raw_html()} else {return(saa_table_gt)}
...
```{r}
#| label: exporting-data-and-pdfs
#| eval: false

# Path to decadal folder:
decadal_folder <- cs_path(box_group = "mills", subfolder = "Projects/Decadal Variability/Graphics/Growth")
...
# # Arrange on a page
# species_laa <- marrangeGrob(laa_figs[1:7], ncol=3, nrow = 5, top=NULL)
