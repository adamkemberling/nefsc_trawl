...
# Throw the percentt change stuff in the data prep:
...
# 
# # Test it out:
# dropin_bars(vals = pchange_wide$indwt_percent_change[[1]],
#             wins = pchange_wide$indwt_wins[[1]],
...
# Join them together
both_nest <- left_join(len_nest, wt_nest, by = "comname")
...
#     ylims = c(-50, 50),
#     aspect_r = 3) %>% 
#    gt::cols_label(waa_change = md('**Weight at Age**<br>1992-2009 to 2010-2019'))
# 
# # Save just length at age
# gtsave(
#   data = wt_bars, 
#   filename = "wt_at_age_percent_changes_table.pdf", 
#   path = str_c(decadal_folder))
# 
# # Length only
# len_bars <- len_nest %>% 
#   gt(rowname_col = "comname") %>%
...
#     ylims = c(-50, 50),
#     aspect_r = 3) %>%
#   gt::cols_label(laa_change = md("**Length at Age**<br>1970-2009 to 2010-2019"))
# 
# # Save just length at age
# gtsave(
#   data = len_bars, 
#   filename = "len_at_age_percent_changes_table.pdf", 
#   path = str_c(decadal_folder))
